...
import com.luxand.alarms.AlarmStateManager;
import com.luxand.facerecognition.R;
import com.luxand.provider.Alarm;
import com.luxand.provider.ClockContract;
import com.luxand.stopwatch.StopwatchService;
import com.luxand.stopwatch.Stopwatches;
import com.luxand.timer.TimerFragment;
import com.luxand.timer.TimerObj;
import com.luxand.timer.Timers;
import com.luxand.worldclock.CitiesActivity;
...
public class DeskClock extends Activity implements LabelDialogFragment.TimerLabelDialogHandler,
    ...
    final Runnable lightUpPiOffline = new Runnable() {
        public void run() {
            ...
            mActionBar.setTitle(
                    Html.fromHtml("Smart Alarm <font color='#" + offlineRed + "'>OFFLINE</font>"));
        }
    };
    final Runnable lightUpPiOnline = new Runnable() {
        public void run() {
            mActionBar.setTitle("Smart Alarm ONLINE");
        }
    };
